...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-149463036-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-149463036-1');
</script>
...
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=2405044859783090&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code -->
  ...
  <meta HTTP-EQUIV="Refresh" CONTENT="4; URL=http://pridestudio.com.ua/">
  <!-- OG -->
